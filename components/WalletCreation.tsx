...
import {
  createChippiPayWallet,
  loginToChippiPayWallet,
  isUsernameAvailable,
  validatePasswordStrength,
  validateEmail,
  CreatedWallet,
  WalletCreationOptions,
} from "@/services/chippiWalletCreation";
...
const WalletCreation: React.FC<WalletCreationProps> = ({
  ...
  const handleCreateWallet = async () => {
    ...
    try {
      ...
      const wallet = await createChippiPayWallet(options);
  ...
  const handleRecoverWallet = async () => {
    ...
    try {
      // For now, just login instead of recovery
      const wallet = await loginToChippiPayWallet(
