...
export const atomicSwapBlocks: BlockType[] = [
  {
    ...
    icon: Wallet,
    description: "Connect your wallet for atomic swaps (Starknet, Bitcoin, Solana)",
    category: "wallet",
    ...
    inputs: [
      ...
      },
      {
        type: "select",
        label: "Wallet Type",
        options: ["ArgentX", "Braavos", "ChippyPay", "Phantom", "Backpack"],
        required: true,
        defaultValue: "ChippyPay",
      },
    ],
    compatibleWith: ["select_swap_pair", "get_quote"],
  },
  {
    id: "select_swap_pair",
