...
pub mod YourCollectible {
    ...
    fn constructor(ref self: ContractState) {
        ...
        let base_uri: ByteArray = "https://ipfs.io/ipfs/BASE/";

        self.erc721.initializer(name, symbol, base_uri);
        self.enumerable.initializer();
        let owner: ContractAddress = 0x04C23F4996013A9A52C78B9f5Ae4D116AC1cb70BB1ED36e193E2901C6479e626.try_into().unwrap();
        let owner: ContractAddress = 0x04C23F4996013A9A52C78B9f5Ae4D116AC1cb70BB1ED36e193E2901C6479e626.try_into().unwrap();
