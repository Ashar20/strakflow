...
const WorkflowPiece: React.FC<WorkflowPieceProps> = ({
  ...
  const PieceContent = () => (
    ...
    >
      ...
      {block.isLoop && isChainPiece && (
        <div className="absolute -top-2 -left-2 bg-indigo-500 text-white text-xs px-2 py-1 rounded-full border-2 border-white shadow-[2px_2px_0_0_rgba(0,0,0,1)] font-bold">
          LOOP
        </div>
      )}
